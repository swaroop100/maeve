...
public class ArrayUse {
	...
	public static void main(String[] args) 
	{
		...
		// Array of references
		FirstClass [] fcls= new FirstClass[2]; 
		fcls[0]= new FirstClass(1,"jan",1990);
		fcls[1]= new FirstClass(2,"oct",1991);
	
		for(FirstClass fc:fcls)
		{
			fc.displayDate(); // FirstClass obj fc we used here
		}
